...
public:
  void InitializeEncryption(const_data_ptr_t iv, idx_t iv_len,
                            const_data_ptr_t key, idx_t key_len,
  ...
  size_t FinalizeGCM(data_ptr_t out, idx_t out_len, data_ptr_t tag,
                     idx_t tag_len);
...
public:
  ...
  CreateEncryptionState(duckdb::EncryptionTypes::CipherType cipher_p,
